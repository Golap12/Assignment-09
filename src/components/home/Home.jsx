  ...
  return (
    <div className="">
      ...
      <div className="md:mt-10 mt-[0.5rem] relative">
        ...
        <div  className="absolute md:top-[100px] top-[50px] left-[10%] md:w-3/4 w-3/4  text-white">
          <h1 className="text-4xl font-extrabold md:w-2/4">Welcome to Your Dream Home</h1>
          <p className="mt-5 text-[#ffffff8f]">
          Find the perfect property for your lifestyle and create lasting memories. Whether you're seeking a cozy apartment in the heart of the city or a luxurious villa overlooking the ocean, we have something for everyone. Let us help you find your ideal home sweet home.
          </p>
          <button className="px-4 py-2 bg-[#08ccc4] text-black font-medium text-lg mt-5">View Properties</button>
        </div>
      </div>
