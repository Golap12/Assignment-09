...
const Footer = () => {
    return (
        <footer className="mt-10 divide-y bg-gray-800 dark:bg-gray-200 text-gray-100 dark:text-gray-800">
            <div className="bg-indigo-100 container px-4 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            ...
            <div className="py-5 text-sm text-center bg-gray-300 text-gray-400 dark:text-gray-600">© 1968 Company Co. All rights reserved.</div>
        </footer>
    );
};
